...
-- BookPaginator.lua (C:\Users\Joan\Zomboid\Workshop\DonQuijoteDeLaMancha\Contents\mods\DonQuijoteDeLaMancha\42\media\lua\shared\QJBookSystem\BookPaginator.lua)
-- Lógica de paginación PURA (sin estado de UI), compartida entre:
--   - BookReader.lua      (construcción perezosa, por lotes, como red
--                          de seguridad si no hubo precarga)
--   - BookPreloader.lua   (construcción completa de una sola vez, al
--                          arrancar la partida)
